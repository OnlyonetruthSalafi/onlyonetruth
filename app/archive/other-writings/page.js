...
const manuscripts = [
  {
    ...
    mark: "BARNABA",
    category: "later",
    categoryLabel: "งานยุคหลัง",
    date: "ต้นฉบับที่เหลืออยู่: ครึ่งหลังศตวรรษที่ 16 | ตัวข้อความ: นักวิชาการให้ช่วง ค.ศ. 1300-1600",
    script: "Italian (ลายมือแบบเวนิส) พร้อมคำอธิบายภาษาอาหรับเขียนแทรกที่ขอบหน้าตลอดเล่ม",
    location: "Österreichische Nationalbibliothek, Vienna (Cod. 2662 Eug.)",
    locationTh:
      "หอสมุดแห่งชาติออสเตรีย เวียนนา (Cod. 2662 Eug.) | ฉบับภาษาสเปนที่คัดในศตวรรษที่ 18 อยู่ที่ Fisher Library มหาวิทยาลัยซิดนีย์",
    contents:
      "222 บท เล่าชีวิตพระเยซูตั้งแต่การแจ้งข่าวถึงการเสด็จขึ้นสวรรค์ — พระเยซูปฏิเสธว่าไม่ใช่บุตรพระเจ้าและไม่ใช่ Messiah ระบุว่ามุฮัมมัดคือ Messiah และยูดาสถูกเปลี่ยนหน้าตาให้ถูกตรึงแทน",
    status:
      "ไม่เคยอยู่ในสารบบใด และไม่ใช่งานคริสต์ศาสนายุคแรก — ไม่มีบิดาคริสตจักรคนใดอ้างถึง ไม่มีชิ้นส่วนภาษากรีกหรือละตินโบราณ และหลักฐานภายในตัวข้อความชี้ไปยุคกลางตอนปลายอย่างหนัก | คนละงานกับ Epistle of Barnabas (ศตวรรษที่ 2) และ Acts of Barnabas (ศตวรรษที่ 5)",
    description:
      "ต้นฉบับที่เหลืออยู่เป็นสมุดกระดาษเขียนด้วยลายมือแบบเวนิส ตราน้ำในกระดาษเป็นรูปสมอในวงกลม ซึ่ง C.M. Briquet ผู้เชี่ยวชาญตราน้ำระบุว่าเป็นกระดาษอิตาลีและ \"ไม่เก่าไปกว่าปี ค.ศ. 1563\" หลักฐานภายในตัวข้อความก็ชี้ไปทางเดียวกัน จุดที่ชัดที่สุดคือบทที่ 82 ซึ่งให้พระเยซูตรัสถึง \"ปีจูบิลี ซึ่งบัดนี้เวียนมาทุกร้อยปี\" — จูบิลีของชาวยิวเวียนทุก 50 ปี ส่วนจูบิลีทุก 100 ปีมีอยู่จริงเพียงช่วงเดียวในประวัติศาสตร์ คือระหว่างที่สมเด็จพระสันตะปาปาโบนิเฟซที่ 8 ทรงประกาศไว้ในปี ค.ศ. 1300 จนถึงปี ค.ศ. 1350 ที่เคลเมนต์ที่ 6 ทรงย่นเหลือ 50 ปี งานชิ้นนี้จึงเป็นเอกสารสำคัญของประวัติศาสตร์ยุคกลาง-ต้นสมัยใหม่ ไม่ใช่พยานของพระเยซูในประวัติศาสตร์",
    note:
      "ต้องแยกให้ขาดจาก \"จดหมายบารนาบัส\" (Epistle of Barnabas) ในคลังเดียวกันนี้ ซึ่งเป็นงานคนละชิ้นจากต้นศตวรรษที่ 2 และอยู่ใน Codex Sinaiticus จริง — สองงานนี้เกี่ยวข้องกันเพียงชื่อที่พ้องกันเท่านั้น อนึ่ง มีการเอ่ยชื่อ \"Evangelium nomine Barnabae\" ไว้ใน Decretum Gelasianum (ศตวรรษที่ 6) และ List of Sixty Books (ศตวรรษที่ 7) จริง แต่ทั้งสองรายการเพียงระบุชื่อไว้ในบัญชีหนังสือต้องห้าม ไม่ได้ยกข้อความใดมาเลย จึงไม่มีทางตรวจสอบได้ว่าหมายถึงข้อความฉบับนี้หรือไม่",
    sourceUrl: "https://archive.org/details/thegospelofbarn00unknuoft",
    // ภาพจริง: ÖNB Cod. 2662, fol. 41r (จากภาพหน้าคู่ 40v-41r บน Wikimedia Commons, สาธารณสมบัติ)
    // gob-card.jpg = ครอปช่วงบทที่ 39 ที่เล่าว่าพระเจ้าเขียนชะฮาดะฮ์ไว้บนเล็บหัวแม่มือของอาดัม
    image: "/manuscripts/other/gospel-barnabas/gob-card.jpg",
    tags: ["Medieval", "Vienna", "Italian", "Pseudepigrapha"],
    scholar: "Lonsdale & Laura Ragg",
    detailPath: "/archive/other-writings/gospel-barnabas",
  },
  {
    id: 14,
    ...
    note:
      "ตัวข้อความไม่เคยเอ่ยชื่อผู้เขียนเลย — ชื่อ \"บารนาบัส\" มาจากธรรมเนียมของอเล็กซานเดรียในภายหลัง และนักวิชาการแทบทั้งหมดเห็นว่าไม่ใช่บารนาบัสเพื่อนร่วมเดินทางของเปาโล งานชิ้นนี้จึงเป็นหลักฐานว่าคริสเตียนกลุ่มหนึ่งในต้นศตวรรษที่ 2 มองศาสนายิวอย่างไร ไม่ใช่หลักฐานว่าชาวยิวเชื่อหรือปฏิบัติอย่างไรจริง | ต้องไม่สับสนกับ Gospel of Barnabas ในหมวดงานยุคหลังของคลังเดียวกันนี้ ซึ่งเป็นงานคนละชิ้นจากยุคกลางตอนปลาย เกี่ยวข้องกันเพียงชื่อที่พ้องกันเท่านั้น",
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            ...
            <p className="font-pridi text-lg md:text-xl text-paper/80 max-w-2xl mx-auto leading-relaxed mb-3">
              ...
              พร้อมหมวดงานยุคหลังที่ถูกอ้างว่าเป็นของยุคแรก
            </p>
            <p className="font-cinzel text-sm text-gold/70">
              1st–16th Century CE | Greek, Coptic, Latin, Ethiopic, Italian |
              50+ Known Texts
            </p>
          </div>
        </div>
