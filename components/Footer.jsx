        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <SocialIcon href="mailto:clovergiver@gmail.com" label="Email">
                <svg
              ...
              <a
                href="mailto:clovergiver@gmail.com"
                className="font-pridi text-sm text-paper/70 hover:text-gold transition-colors duration-300"
              >
                clovergiver@gmail.com
              </a>
            </div>
          </div>
        </div>
