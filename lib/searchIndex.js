...
export const searchIndex = [
  ...
  {
    title: "Non-Muslim Contemporary Sources on the Historical Muhammad",
    titleTh: "หลักฐานนอกระบบคัมภีร์: การมีตัวตนของศาสดามุฮัมมัดในบันทึกร่วมสมัยศตวรรษที่ 7",
    url: "/articles/muhammad-non-muslim-sources",
    type: "article",
    keywords: ["doctrina jacobi", "โดคทรินา", "thomas the presbyter", "โธมัส", "เพรสไบเตอร์", "sebeos", "เซเบออส", "zuhayr", "ซุฮัยร์", "จารึก", "inscription", "dome of the rock", "โดมแห่งศิลา", "abd al-malik", "อับดุลมะลิก", "เหรียญ", "coin", "dinar", "ดีนาร์", "dirham", "ดิรฮัม", "syriac", "ซีรีแอก", "armenian", "อาร์เมเนีย", "saracen", "ซาราเซน", "historicity", "ประวัติศาสตร์", "มุฮัมมัด", "muhammad", "non-muslim sources"],
    description: "เอกสารกรีก ซีรีแอก อาร์เมเนีย จารึกหิน เหรียญกษาปณ์ และโดมแห่งศิลา ที่บันทึกถึงท่านนบีโดยผู้ที่ไม่ได้นับถืออิสลาม",
  },
];
